...
project_id = conf["history"]["project_id"]
bq_dataset_to_export = conf["history"]["bq_dataset_to_export"]
src_osm_gcs_uri = conf["history"]["src_osm_gcs_uri"]

gcs_work_bucket = conf["history"]["gcs_work_bucket"]

osm_converter_with_history_index_image = conf["history"]["osm_converter_with_history_index_image"]

gke_main_cluster_name = conf["history"]["gke_main_cluster_name"]
gke_zone = conf["history"]["gke_zone"]

addt_sn_gke_pool = conf["history"]["addt_sn_gke_pool"]
addt_sn_gke_pool_machine_type = conf["history"]["addt_sn_gke_pool_machine_type"]
addt_sn_gke_pool_disk_size = conf["history"]["addt_sn_gke_pool_disk_size"]
addt_sn_gke_pool_num_nodes = conf["history"]["addt_sn_gke_pool_num_nodes"]
addt_sn_gke_pool_max_num_treads = conf["history"]["addt_sn_gke_pool_max_num_treads"]

addt_mn_gke_pool = conf["history"]["addt_mn_gke_pool"]
addt_mn_gke_pool_machine_type = conf["history"]["addt_mn_gke_pool_machine_type"]
addt_mn_gke_pool_disk_size = conf["history"]["addt_mn_gke_pool_disk_size"]
addt_mn_gke_pool_num_nodes = conf["history"]["addt_mn_gke_pool_num_nodes"]
addt_mn_pod_requested_memory = conf["history"]["addt_mn_pod_requested_memory"]

generate_layers_image = conf["history"]["generate_layers_image"]
test_osm_gcs_uri = ""
