...
project_id = conf["transfer_src_history"]["project_id"]
osm_url = conf["transfer_src_history"]["osm_url"]
osm_md5_url = conf["transfer_src_history"]["osm_md5_url"]
transfer_index_files_dir_gcs_uri = conf["transfer_src_history"]["transfer_index_files_dir_gcs_uri"]
gcs_transfer_bucket = conf["transfer_src_history"]["gcs_transfer_bucket"]
